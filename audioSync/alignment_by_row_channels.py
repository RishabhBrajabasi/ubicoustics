...
def align(video1, video2, fft_bin_size=1024, overlap=0, box_height=512, box_width=43, samples_per_box=7):
    ...
    # Currently it assumes a sampling rate of 44100 afor 2 minutes.
    # this way it does not have to load the full file. Useful, specially for larger files
    # But then the start times of the videos/audio have to be within two minutes of each other
    ...
    raw_audio2, rate = read_audio(video2)
...
# ======= TEST FILES ==============
#audio1 = "8k_1859_sync.wav"
#audio2 = "8k_1877_sync.wav"
audio1 = "chopping_SU_61.wav"
audio2 = "counterTop_SU_65.wav"
# audio1 = "DanielZ5PPlk53IMY.mp4"
# audio2 = "Daniel08ycq2T_ab4.mp4"
# directory = "./uploads/"
t = align(audio1, audio2)
if t[0] is 0:
    print ("Audio file 2 leads Audio file 1 by %6.4f seconds. " %(t[1]))
else:
    print ("Audio file 1 leads Audio file 2 by %6.4f seconds. " %(t[0]))
